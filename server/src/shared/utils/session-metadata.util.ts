/**
 * - Determines user's IP based on environment.
- Uses `geoip-lite` to look up city & country.
- Uses `device-detector-js` to extract browser, OS, and type.
- Returns all that in a `SessionMetadata` object.
 */
